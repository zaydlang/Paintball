...
public class ConnectedPlayer extends Element {
    ...
    private ConnectedPlayer(double x, double y, double width, double height) {
    ...
    public ConnectedPlayer(String ip, int port) throws Exception {
        ...
        if (s.getInputStream().available() != 0) {
             ...
             setX(Double.parseDouble(initArgs[0]));
             setY(Double.parseDouble(initArgs[1]));
             setWidth(Double.parseDouble(initArgs[2]));
             setHeight(Double.parseDouble(initArgs[3]));
